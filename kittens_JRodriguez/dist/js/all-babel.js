...
window.Modernizr = function (e, t, n) {
  ...
  function l() {
    m.input = function (n) {
      ...
      for (var r, o, i, a = 0, c = e.length; c > a; a++) {
        x.setAttribute("type", o = e[a]), r = "text" !== x.type, r && (x.value = C, x.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && x.style.WebkitAppearance !== n ? (g.appendChild(x), i = t.defaultView, r = i.getComputedStyle && "textfield" !== i.getComputedStyle(x, null).WebkitAppearance && 0 !== x.offsetHeight, g.removeChild(x)) : /^(search|tel)$/.test(o) || (/^(url|email)$/.test(o) ? r = x.checkValidity && x.checkValidity() === !1 : /^color$/.test(o) ? (g.appendChild(x), g.offsetWidth, r = x.value != C, g.removeChild(x)) : r = x.value != C)), M[e[a]] = !!r;
      }
  ...
  var d,
    ...
    var i,
        ...
        u = t.body,
        l = u ? u : t.createElement("body");
    if (parseInt(r, 10)) for (; r--;) {
      c = t.createElement("div"), c.id = o ? o[r] : v + (r + 1), s.appendChild(c);
    }
    return i = ["&#173;", "<style>", e, "</style>"].join(""), s.id = v, l.innerHTML += i, l.appendChild(s), u || g.appendChild(l), a = n(s, e), u ? s.parentNode.removeChild(s) : l.parentNode.removeChild(l), !!a;
  },
      O = function O(t) {
  ...
  !function (n, r) {
    var o = n.join(""),
        i = r.length;
    $(o, function (n, r) {
      for (var o = t.styleSheets[t.styleSheets.length - 1], a = o ? o.cssRules && o.cssRules[0] ? o.cssRules[0].cssText : o.cssText || "" : "", c = n.childNodes, s = {}; i--;) {
        s[c[i].id] = c[i];
      }

      m.touch = "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch || 9 === (s.touch && s.touch.offsetTop), m.csstransforms3d = 9 === (s.csstransforms3d && s.csstransforms3d.offsetLeft) && 3 === s.csstransforms3d.offsetHeight, m.generatedcontent = (s.generatedcontent && s.generatedcontent.offsetHeight) >= 1, m.fontface = /src/i.test(a) && 0 === a.indexOf(r.split(" ")[0]);
    }, i, r);
  }(['@font-face {font-family:"font";src:url("https://")}', ["@media (", S.join("touch-enabled),("), v, ")", "{#touch{top:9px;position:absolute}}"].join(""), ["@media (", S.join("transform-3d),("), v, ")", "{#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join(""), ['#generatedcontent:after{content:"', C, '";visibility:hidden}'].join("")], ["fontface", "touch", "csstransforms3d", "generatedcontent"]);
  N.flexbox = function () {
    return u("flexOrder");
  }, N.canvas = function () {
    ...
    try {
      ...
      r = !(!e.WebGLRenderingContext || !o.getContext("experimental-webgl") && !o.getContext("webgl")), o = n;
    } catch (i) {
      r = !1;
    }
    ...
    var e = !!u("perspective");
    return e && "webkitPerspective" in g.style && (e = m.csstransforms3d), e;
    ...
    return !!t.createElementNS && /SVGAnimate/.test(E.call(t.createElementNS(j.svg, "animate")));
  }, N.svgclippaths = function () {
    return !!t.createElementNS && /SVGClipPath/.test(E.call(t.createElementNS(j.svg, "clipPath")));
  };

  for (var B in N) {
    f(N, B) && (d = B.toLowerCase(), m[d] = N[B](), A.push((m[d] ? "" : "no-") + d));
  }
  ...
  return m.input || l(), m.addTest = function (e, t) {
    if ("object" == _typeof(e)) for (var r in e) {
      ...
      t = "function" == typeof t ? t() : t, g.className += " " + (t ? "" : "no-") + e, m[e] = t;
    }
    return m;
    ...
    function o(e) {
      function t() {
        var e = f.cloneNode(!1);
        return l.shivMethods ? (o(e), e) : e;
      }

      function n(e) {
        var t = (a[e] || (a[e] = c(e))).cloneNode(!1);
        return l.shivMethods && !u.test(e) ? f.appendChild(t) : t;
      }

      for (var i, a = {}, c = e.createElement, s = e.createDocumentFragment, d = r(), f = s(), p = d.length; p--;) {
        i = d[p], a[i] = c(i), f.createElement(i);
      }

      e.createElement = n, e.createDocumentFragment = t;
    }

    function i(e) {
      var t;
      return e.documentShived ? e : (l.shivCSS && !a && (t = !!n(e, "article,aside,details,figcaption,figure,footer,header,hgroup,nav,section{display:block}audio{display:none}canvas,video{display:inline-block;*display:inline;*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:inline;*zoom:1}mark{background:#FF0;color:#000}")), l.shivMethods && !c && (t = !o(e)), t && (e.documentShived = t), e);
    }

    var a,
        c,
        s = e.html5 || {},
        u = /^<|^(?:button|iframe|input|script|textarea)$/i;
    !function () {
      var n,
          r = t.createElement("a"),
          o = e.getComputedStyle,
          i = t.documentElement,
          s = t.body || (n = i.insertBefore(t.createElement("body"), i.firstChild));
      s.insertBefore(r, s.firstChild), r.hidden = !0, r.innerHTML = "<xyz></xyz>", a = "none" == (r.currentStyle || o(r, null)).display, c = 1 == r.childNodes.length || function () {
        try {
          t.createElement("a");
        } catch (e) {
          return !0;
      ...
      }(), s.removeChild(r), n && i.removeChild(n);
    }();
    var l = {
      elements: s.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),
      shivCSS: s.shivCSS !== !1,
    ...
    e.html5 = l, i(t);
  }(this, t), m._version = p, m._prefixes = S, m._domPrefixes = T, m._cssomPrefixes = k, m.mq = O, m.hasEvent = z, m.testProp = function (e) {
    return c([e]);
  }, m.testAllProps = u, m.testStyles = $, m.prefixed = function (e, t, n) {
    return t ? u(e, t, n) : u(e, "pfx");
  }, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + A.join(" ") : ""), m;
}(void 0, (void 0).document), function (e, t, n) {
  function r(e) {
  ...
  function c() {
    ...
    y = 1, e ? e.t ? m(function () {
      ("c" == e.t ? _f.injectCss : _f.injectJs)(e.s, 0, e.a, e.x, e.e, 1);
    }, 0) : (e(), c()) : y = 0;
  }

  function s(e, n, r, o, i, s, u) {
    function l(t) {
      if (!p && a(d.readyState) && (b.r = p = 1, !y && c(), d.onload = d.onreadystatechange = null, t)) {
        "img" != e && m(function () {
          C.removeChild(d);
        }, 50);
    ...
    1 === T[n] && (g = 1, T[n] = [], d = t.createElement(e)), "object" == e ? d.data = n : (d.src = n, d.type = e), d.width = d.height = "0", d.onerror = d.onload = d.onreadystatechange = function () {
      l.call(this, g);
    }, v.splice(o, 0, b), "img" != e && (g || 2 === T[n] ? (C.insertBefore(d, x ? null : h), m(l, u)) : T[n].push(d));
  }

  function u(e, t, n, r, i) {
    return y = 0, t = t || "j", o(e) ? s("c" == t ? S : E, e, t, this.i++, n, r, i) : (v.splice(this.i++, 0, e), 1 == v.length && c()), this;
  }
  ...
  _f = function f(e) {
    ...
    function a(e, o, i, a, s) {
      var u = t(e),
          d = u.autoCallback;
      u.url.split(".").pop().split("?").shift(), u.bypass || (o && (o = r(o) ? o : o[e] || o[a] || o[e.split("/").pop().split("?")[0]] || c), u.instead ? u.instead(e, o, i, a, s) : (T[u.url] ? u.noexec = !0 : T[u.url] = 1, i.load(u.url, u.forceCSS || !u.forceJS && "css" == u.url.split(".").pop().split("?").shift() ? "c" : n, u.noexec, u.attrs, u.timeout), (r(o) || r(d)) && i.load(function () {
        l(), o && o(u.origUrl, s, a), d && d(u.origUrl, s, a), T[u.url] = 2;
      })));
    }
    ...
    function s(e, t) {
      function n(e, n) {
        if (e) {
          if (o(e)) n || (d = function d() {
            var e = [].slice.call(arguments);
            f.apply(this, e), p();
          }), a(e, d, t, 0, u);else if (Object(e) === e) for (s in c = function () {
            var t,
                n = 0;
            ...
            e.hasOwnProperty(s) && (!n && ! --c && (r(d) ? d = function d() {
              var e = [].slice.call(arguments);
              f.apply(this, e), p();
            } : d[s] = function (e) {
              return function () {
    ...
    if (o(e)) a(e, 0, p, 0);else if (w(e)) for (u = 0; u < e.length; u++) {
      d = e[u], o(d) ? a(d, 0, p, 0) : w(d) ? _f(d) : Object(d) === d && s(d, p);
    } else Object(e) === e && s(e, p);
  }, _f.addPrefix = function (e, t) {
    j[e] = t;
  }, _f.addFilter = function (e) {
    k.push(e);
  }, _f.errorTimeout = 1e4, null == t.readyState && t.addEventListener && (t.readyState = "loading", t.addEventListener("DOMContentLoaded", _d = function d() {
    t.removeEventListener("DOMContentLoaded", _d, 0), t.readyState = "complete";
...
!function (e, t) {
  ...
  function k(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) {
      "margin" === n && (s += ee.css(e, n + Te[o], !0, i)), r ? ("content" === n && (s -= ee.css(e, "padding" + Te[o], !0, i)), "margin" !== n && (s -= ee.css(e, "border" + Te[o] + "Width", !0, i))) : (s += ee.css(e, "padding" + Te[o], !0, i), "padding" !== n && (s += ee.css(e, "border" + Te[o] + "Width", !0, i)));
    }
  ...
  function D(e, t) {
    for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) {
      r = e[s], r.style && (o[s] = ve.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ce(r) && (o[s] = ve.access(r, "olddisplay", b(r.nodeName)))) : o[s] || (i = Ce(r), (n && "none" !== n || !i) && ve.set(r, "olddisplay", i ? n : ee.css(r, "display"))));
    }
  ...
  function O(e, t, n) {
    var r,
      ...
      for (var t = Qe || S(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) {
        l.tweens[s].run(o);
      }
  ...
  function $(e, t, n, r) {
    ...
    if (ee.isArray(t)) ee.each(t, function (t, i) {
      n || kt.test(e) ? r(e, i) : $(e + "[" + ("object" == _typeof(i) ? t : "") + "]", i, n, r);
    });else if (n || "object" !== ee.type(t)) r(e, t);else for (i in t) {
      $(e + "[" + i + "]", t[i], n, r);
    }
  }
  ...
  ee.fn = ee.prototype = {
    ...
    for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == _typeof(s) || ee.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++) {
      if (null != (e = arguments[a])) for (t in e) {
        n = s[t], r = e[t], s !== r && (l && r && (ee.isPlainObject(r) || (i = ee.isArray(r))) ? (i ? (i = !1, o = n && ee.isArray(n) ? n : []) : o = n && ee.isPlainObject(n) ? n : {}, s[t] = ee.extend(l, o, r)) : void 0 !== r && (s[t] = r));
      }
    }
    ...
    type: function type(e) {
      return null == e ? e + "" : "object" == _typeof(e) || "function" == typeof e ? V[Y.call(e)] || "object" : _typeof(e);
    },
    ...
    proxy: function proxy(e, t) {
      var n, r, i;
      return "string" == typeof t && (n = e[t], t = e, e = n), ee.isFunction(e) ? (r = _.call(arguments, 2), i = function i() {
  ...
  var ie = function (e) {
      ...
      if (O && !r) {
        ...
        if (C.qsa && (!F || !F.test(e))) {
          if (h = f = W, g = t, m = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
            for (l = p(e), (f = t.getAttribute("id")) ? h = f.replace(be, "\\$&") : t.setAttribute("id", h), h = "[id='" + h + "'] ", u = l.length; u--;) {
              l[u] = h + d(l[u]);
            }
    ...
    function c(e) {
      return e && _typeof(e.getElementsByTagName) !== V && e;
    }
    ...
    function p(e, n) {
      ...
      for (a = e, u = [], l = N.preFilter; a;) {
        ...
        for (s in N.filter) {
          !(i = he[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), o.push({
            value: r,
            type: s,
            matches: i
          }), a = a.slice(r.length));
    ...
    function v(e, t, n, i, o, s) {
      return i && !i[W] && (i = v(i)), o && !o[W] && (o = v(o, s)), r(function (r, s, a, u) {
        var l,
            ...
            y = n ? o || (r ? e : h || i) ? [] : s : v;
        if (n && n(v, y, a, u), i) for (l = m(y, d), i(l, [], a, u), c = l.length; c--;) {
          (f = l[c]) && (y[d[c]] = !(v[d[c]] = f));
        }
        ...
        if (r) {
          if (o || e) {
            ...
            for (c = y.length; c--;) {
              (f = y[c]) && (l = o ? te.call(r, f) : p[c]) > -1 && (r[l] = !(s[l] = f));
            }
          }
    ...
    function y(e) {
      for (var t, n, r, i = e.length, o = N.relative[e[0].type], s = o || N.relative[" "], a = o ? 1 : 0, u = h(function (e) {
        ...
        if (n = N.relative[e[a].type]) c = [h(g(c), n)];else {
    ...
    function x(e, n) {
      var i = n.length > 0,
        ...
        for (l && (j = _s !== q && _s); h !== w && null != (c = x[h]); h++) {
          if (o && c) {
            for (f = 0; p = e[f++];) {
              if (p(c, _s, a)) {
                u.push(c);
    ...
    C = t.support = {}, E = t.isXML = function (e) {
      ...
      return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, H = n.documentElement, O = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
        ...
        if (_typeof(t.getElementById) !== V && O) {
        ...
        return _typeof(t.getElementsByClassName) !== V && O ? t.getElementsByClassName(e) : void 0;
      ...
      filter: {
        ...
        CLASS: function CLASS(e) {
          ...
          return t || (t = new RegExp("(^|" + re + ")" + e + "(" + re + "|$)")) && _(e, function (e) {
            return t.test("string" == typeof e.className && e.className || _typeof(e.getAttribute) !== V && e.getAttribute("class") || "");
          });
        },
  ...
  var ue,
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (t = t instanceof ee ? t[0] : t, ee.merge(this, ee.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : K, !0)), se.test(n[1]) && ee.isPlainObject(t)) for (n in t) {
  ...
  ee.Callbacks = function (e) {
    ...
    when: function when(e) {
      ...
      if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) {
        o[i] && ee.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --a;
      }
  ...
  var me = ee.access = function (e, t, n, r, i, o, s) {
    ...
    if ("object" === ee.type(n)) {
      ...
      for (a in n) {
        ee.access(e, t, a, n[a], !0, o, s);
      }
    } else if (void 0 !== r && (i = !0, ee.isFunction(r) || (s = !0), l && (s ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t, n) {
  ...
  ee.acceptData = function (e) {
    ...
    set: function set(e, t, n) {
      var r,
          i = this.key(e),
          o = this.cache[i];
      if ("string" == typeof t) o[t] = n;else if (ee.isEmptyObject(o)) ee.extend(this.cache[i], t);else for (r in t) {
        o[r] = t[r];
      }
      return o;
    },
  ...
  ee.extend({
    ...
    data: function data(e, t) {
      ...
      if (void 0 === e) {
        if (this.length && (i = ye.get(o), 1 === o.nodeType && !ve.get(o, "hasDataAttrs"))) {
          for (n = s.length; n--;) {
            r = s[n].name, 0 === r.indexOf("data-") && (r = ee.camelCase(r.slice(5)), u(o, r, i[r]));
          }
    ...
    promise: function promise(e, t) {
      ...
      for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) {
        n = ve.get(o[s], e + "queueHooks"), n && n.empty && (r++, n.empty.add(a));
      }
  ...
  ee.event = {
    ...
    add: function add(e, t, n, r, i) {
      var o,
          ...
          g,
          m = ve.get(e);
      if (m) for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = ee.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
        return _typeof(ee) !== ke && ee.event.triggered !== t.type ? ee.event.dispatch.apply(e, arguments) : void 0;
      }), t = (t || "").match(de) || [""], l = t.length; l--;) {
        a = Se.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = ee.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = ee.event.special[d] || {}, c = ee.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
    ...
    trigger: function trigger(t, n, r, i) {
      ...
      if (s = a = r = r || K, 3 !== r.nodeType && 8 !== r.nodeType && !je.test(d + ee.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[ee.expando] ? t : new ee.Event(d, "object" == _typeof(t) && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ee.makeArray(n, [t]), f = ee.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
        if (!i && !f.noBubble && !ee.isWindow(r)) {
          for (u = f.delegateType || d, je.test(u + d) || (s = s.parentNode); s; s = s.parentNode) {
            p.push(s), a = s;
          }
        ...
        for (o = 0; (s = p[o++]) && !t.isPropagationStopped();) {
          t.type = o > 1 ? u : f.bindType || d, c = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && ee.acceptData(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
        }
      ...
      if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
        for (s = ee.event.handlers.call(this, e, u), t = 0; (i = s[t++]) && !e.isPropagationStopped();) {
          for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();) {
            (!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o, e.data = o.data, r = ((ee.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
          }
        }
    ...
    handlers: function handlers(e, t) {
      ...
      if (a && u.nodeType && (!e.button || "click" !== e.type)) for (; u !== this; u = u.parentNode || this) {
        if (u.disabled !== !0 || "click" !== e.type) {
          for (r = [], n = 0; a > n; n++) {
            o = t[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? ee(i, this).index(u) >= 0 : ee.find(i, this, null, [u]).length), r[i] && r.push(o);
          }
    ...
    fix: function fix(e) {
      ...
      for (s || (this.fixHooks[i] = s = De.test(i) ? this.mouseHooks : Ee.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new ee.Event(o), t = r.length; t--;) {
        n = r[t], e[n] = o[n];
      }
  ...
  Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, ee.extend({
    clone: function clone(e, t, n) {
      ...
      if (!(J.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ee.isXMLDoc(e))) for (s = v(a), o = v(e), r = 0, i = o.length; i > r; r++) {
        y(o[r], s[r]);
      }
      if (t) if (n) for (o = o || v(e), s = s || v(a), r = 0, i = o.length; i > r; r++) {
        m(o[r], s[r]);
      } else m(e, a);
    ...
    buildFragment: function buildFragment(e, t, n, r) {
      for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++) {
        if (i = e[p], i || 0 === i) if ("object" === ee.type(i)) ee.merge(f, i.nodeType ? [i] : i);else if (qe.test(i)) {
      ...
      for (c.textContent = "", p = 0; i = f[p++];) {
        if ((!r || -1 === ee.inArray(i, r)) && (u = ee.contains(i.ownerDocument, i), o = v(c.appendChild(i), "script"), u && g(o), n)) for (l = 0; i = o[l++];) {
    ...
    cleanData: function cleanData(e) {
      for (var t, n, r, i, o, s, a = ee.event.special, u = 0; void 0 !== (n = e[u]); u++) {
        if (ee.acceptData(n) && (o = n[ve.expando], o && (t = ve.cache[o]))) {
          if (r = Object.keys(t.events || {}), r.length) for (s = 0; void 0 !== (i = r[s]); s++) {
            a[i] ? ee.event.remove(n, i) : ee.removeEvent(n, i, t.handle);
          }
    ...
    empty: function empty() {
      for (var e, t = 0; null != (e = this[t]); t++) {
        1 === e.nodeType && (ee.cleanData(v(e, !1)), e.textContent = "");
      }
    ...
    html: function html(e) {
      return me(this, function (e) {
        ...
        if ("string" == typeof e && !He.test(e) && !Re[(Le.exec(e) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; r > n; n++) {
              t = this[n] || {}, 1 === t.nodeType && (ee.cleanData(v(t, !1)), t.innerHTML = e);
            }
    ...
    domManip: function domManip(e, t) {
      ...
      if (l && (n = ee.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
        for (i = ee.map(v(n, "script"), d), o = i.length; l > u; u++) {
          s = n, u !== f && (s = ee.clone(s, !0, !0), o && ee.merge(i, v(s, "script"))), t.call(this[u], s, u);
        }

        if (o) for (a = i[i.length - 1].ownerDocument, ee.map(i, h), u = 0; o > u; u++) {
    ...
    ee.fn[e] = function (e) {
      for (var n, r = [], i = ee(e), o = i.length - 1, s = 0; o >= s; s++) {
        n = s === o ? this : this.clone(!0), ee(i[s])[t](n), z.apply(r, n.get());
      }
  ...
  ee.extend({
    ...
    style: function style(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
            ...
            a = ee.camelCase(t),
            u = e.style;
        return t = ee.cssProps[a] || (ee.cssProps[a] = C(u, a)), s = ee.cssHooks[t] || ee.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : (o = _typeof(n), "string" === o && (i = Ue.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(ee.css(e, t)), o = "number"), void (null != n && n === n && ("number" !== o || ee.cssNumber[a] || (n += "px"), J.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = "", u[t] = n))));
      }
    },
    ...
    run: function run(e) {
      ...
      return this.pos = t = this.options.duration ? ee.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : j.propHooks._default.set(this), this;
    }
  ...
  ee.fn.extend({
    ...
    removeAttr: function removeAttr(e, t) {
      ...
      if (o && 1 === e.nodeType) for (; n = o[i++];) {
        r = ee.propFix[n] || n, ee.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n);
      }
    },
    attrHooks: {
      type: {
  ...
  ee.fn.extend({
    ...
    prop: function prop(e, t, n) {
      var r,
          ...
          o,
          s = e.nodeType;
      return e && 3 !== s && 8 !== s && 2 !== s ? (o = 1 !== s || !ee.isXMLDoc(e), o && (t = ee.propFix[t] || t, i = ee.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]) : void 0;
    },
    propHooks: {
      tabIndex: {
        get: function get(e) {
  ...
  ee.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ee.isFunction(e) ? function (n) {
        ...
        if ("string" === n) for (var t, r = 0, i = ee(this), o = e.match(de) || []; t = o[r++];) {
  ...
  ee.fn.extend({
    ...
    valHooks: {
      select: {
        ...
        set: function set(e, t) {
          for (var n, r, i = e.options, o = ee.makeArray(t), s = i.length; s--;) {
            r = i[s], (r.selected = ee.inArray(ee(r).val(), o) >= 0) && (n = !0);
          }
    ...
    return J.cors || qt && !e.crossDomain ? {
      send: function send(n, r) {
        var i,
            o = e.xhr(),
            s = ++St;
        if (o.open(e.type, e.url, e.async, e.username, e.password), e.xhrFields) for (i in e.xhrFields) {
          o[i] = e.xhrFields[i];
        }
        ...
        _t2 = function t(e) {
          return function () {
            _t2 && (delete At[s], _t2 = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(Lt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
              text: o.responseText
            } : void 0, o.getAllResponseHeaders()));
          };
        }, o.onload = _t2(), o.onerror = _t2("error"), _t2 = At[s] = _t2("abort"), o.send(e.hasContent && e.data || null);
      },
  ...
  ee.fn.load = function (e, t, n) {
    ...
    var r,
        ...
        s = this,
        a = e.indexOf(" ");
    return a >= 0 && (r = e.slice(a), e = e.slice(0, a)), ee.isFunction(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), s.length > 0 && ee.ajax({
      url: e,
      type: i,
      dataType: "html",
      data: t
    ...
    offset: function offset(e) {
      ...
      var t,
        ...
        left: 0
          ...
          o = r && r.ownerDocument;
      return o ? (t = o.documentElement, ee.contains(t, r) ? (_typeof(r.getBoundingClientRect) !== ke && (i = r.getBoundingClientRect()), n = B(o), {
...
$(".kittens").find("li").each(function (e, n) {
  var t = $(n).find("img"),
      ...
      i = 250,
      o = 250;
  t.attr("src", "http://placekitten.com/" + i + "/" + o + "?image=" + e), a.text(names[e]), s.text(ages[e]);
});